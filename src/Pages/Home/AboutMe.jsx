  ...
  return (
    <section id="AboutMe" className="about--section">
      <div className="about--section--img">
        <img src="./img/about-me-image.jpg" alt="About Me" />
      </div>
      <div className="hero--section--content--box about--section--box">
        <div className="hero--section--content">
          ...
          <p className="hero--section-description">
            I'm NaveenKumar R, a skilled Full Stack Web Developer renowned for crafting stunning websites with precision and elegance. My expertise lies in leveraging cutting-edge technologies such as React.js, SCSS, and Bootstrap to create visually appealing and seamlessly functional web experiences.
          </p>
          <p className="hero--section-description">
